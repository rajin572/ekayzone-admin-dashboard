...
const SignIn = () => {
    ...
    const onFinish = async (_data: z.infer<typeof signInSchema>) => {
        ...
        //     Cookies.remove("eKayzone_main_forgetToken");
        //     Cookies.remove("eKayzone_main_forgetEmail");
        //     Cookies.remove("eKayzone_main_forgetOtpMatchToken");
        //     Cookies.set("eKayzone_main_accessToken", res?.data?.accessToken, {
        //         path: "/",
        //         expires: 365,
        //         secure: false,
        //     });
            ...
            <form onSubmit={form.handleSubmit(onFinish)}>
                <FieldGroup>
                    <FormInput
                        ...
                        name="email"
                        label="Email Address"
                        placeholder="admin@eKayzone.com"
